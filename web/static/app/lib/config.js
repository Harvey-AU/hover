 ...
 * The server populates window.BGNH_CONFIG via /config.js before any
 ...
 * window.BGNH_CONFIG directly.
 *
 * Transition note: window.BGNH_CONFIG is set by the legacy server
 * endpoint. The name will change when the server config endpoint is
 * updated. At that point, only this file needs to change.
 */

const raw = (typeof window !== "undefined" && window.BGNH_CONFIG) || {};
